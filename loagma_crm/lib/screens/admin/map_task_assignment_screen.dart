...
class MapTaskAssignmentScreen extends StatefulWidget {
  ...
  @override
  State<MapTaskAssignmentScreen> createState() =>
      _MapTaskAssignmentScreenState();
}

class _MapTaskAssignmentScreenState extends State<MapTaskAssignmentScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pin-Code Task Assignment'),
