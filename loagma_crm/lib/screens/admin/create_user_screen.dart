...
>>>>>>> f4afc93f9441ec54221a2ce0ab45a5b4a3028517
  ...
  Future<void> _saveWorkingHours(String employeeId) async {
    try {
      ...
      final url = Uri.parse(
        '${ApiConfig.baseUrl}/employee-working-hours/$employeeId',
      );
      final response = await http
          .put(
            url,
...
>>>>>>> f4afc93f9441ec54221a2ce0ab45a5b4a3028517
      ...
      if (data["success"] == true) {
        ...
        final newUserId = data['user']?['id'] ?? data['data']?['id'];
        if (newUserId != null) {
          await _saveWorkingHours(newUserId);
        }
        ...
        setState(() {
          ...
          _latePunchInGraceMinutes = 45;
          _earlyPunchOutGraceMinutes = 30;
        });
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Row(
                        children: [
                          Icon(Icons.schedule, color: Color(0xFFD7BE69)),
                          SizedBox(width: 10),
                          Text(
                            "Working Hours",
                            style: TextStyle(
