...
class MinimalAttendanceDashboard extends StatefulWidget {
  const MinimalAttendanceDashboard({Key? key}) : super(key: key);

  @override
  State<MinimalAttendanceDashboard> createState() =>
      _MinimalAttendanceDashboardState();
}

class _MinimalAttendanceDashboardState extends State<MinimalAttendanceDashboard>
  ...
  Widget _buildDashboardPage() {
    ...
    final absentCount =
        totalEmployees - presentCount; // Fix the negative absent count
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  _buildFilterChip('Present', 'active'),
                  const SizedBox(width: 8),
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(
                'Live Locations (${markers.length} employees)',
                style: const TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
                ),
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: _buildQuickStat(
                              'Active',
                              '${dashboardData['statistics']?['activeCount'] ?? 0}',
                              Colors.orange,
                            ),
                          ),
                          Expanded(
                            child: _buildQuickStat(
                              'Completed',
                              '${dashboardData['statistics']?['completedCount'] ?? 0}',
                              Colors.blue,
                            ),
                          ),
                        ],
